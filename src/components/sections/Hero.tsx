...
import HeroAnimatedLines from "@/components/ui/HeroAnimatedLines";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p 
          className="font-editorial text-lg md:text-2xl lg:text-3xl text-foreground/80 mb-16 max-w-2xl mx-auto leading-relaxed"
